            ...
            if (!param1) {
			    ...
			    if(!param2) {
					...
					send_cmd(ci->bi->nick, "MSG CHANSERV SOP %s %s %s", ci->name, param1,
                        ...
                        notice(whosends(ci), u->nick,
                               "%s a �t� ajout� a la liste des SOP ", param2);
                    }

                    else {

                        notice(whosends(ci), u->nick,
                               "%s ne peut etre ajout� a la liste des SOP, %s n'est pas conect� !",
                               param2, param2);
                    }
				}
            ...
            if (!param1) {
			    ...
			    if(!param2) {
					...
					send_cmd(ci->bi->nick, "MSG CHANSERV AOP %s %s %s", ci->name, param1,
                        ...
                        notice(whosends(ci), u->nick,
                               "%s a �t� ajout� a la liste des AOP ", param2);
                    }

                    else {

                        notice(whosends(ci), u->nick,
                               "%s ne peut etre ajout� a la liste des AOP, %s n'est pas conect� !",
                               param2, param2);
                    }
				}
			}else if(!stricmp(param1, "clear")){
            ...
            if (!param1) {
			    ...
			    if(!param2) {
					...
					send_cmd(ci->bi->nick, "MSG CHANSERV HOP %s %s %s", ci->name, param1,
                        ...
                        notice(whosends(ci), u->nick,
                               "%s a �t� ajout� a la liste des HOP ", param2);
                    }

                    else {

                        notice(whosends(ci), u->nick,
                               "%s ne peut etre ajout� a la liste des HOP, %s n'est pas conect� !",
                               param2, param2);
                    }
				}
			}else if(!stricmp(param1, "clear")){
            ...
            if(!param1) {
			    ...
			    if(!param2) {
					...
					send_cmd(ci->bi->nick, "MSG CHANSERV VOP %s %s %s", ci->name, param1,
                        ...
                        notice(whosends(ci), u->nick,
                               "%s a �t� ajout� a la liste des vOP ", param2);
                    }

                    else {

                        notice(whosends(ci), u->nick,
                               "%s ne peut etre ajout� a la liste des VOP, %s n'est pas conect� !",
                               param2, param2);
                    }
				}
			}else if(!stricmp(param1, "clear")){
